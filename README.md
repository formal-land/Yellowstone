...
As more and more code is written using AI and vulnerability discovery increases with AI, it becomes increasingly important to trust and understand the code we use.

Yellowstone aims to increase the understanding of the code by following functional programming principles:

- Pure functions
- Everything else in a free monad to represent side effects

This uniform representation of effects allows us to:
...
- Make an extension of your code/programming language with additional information to represent the explicit effects.
- Have a tool to erase this additional information to get back the original code.
